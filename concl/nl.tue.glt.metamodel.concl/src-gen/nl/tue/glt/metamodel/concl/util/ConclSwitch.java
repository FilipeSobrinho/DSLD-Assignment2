 ...
 * @generated
 */
public class ConclSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ConclPackage.CONSOLE_PACK: {
			ConsolePack consolePack = (ConsolePack) theEObject;
			T result = caseConsolePack(consolePack);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Console Pack</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Console Pack</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConsolePack(ConsolePack object) {
		return null;
	}
